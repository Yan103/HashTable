...
Таким образом, при использовании двух оптимизаций, удалось добиться ускорения программы в $k = \frac{6142775058}{422734737} \approx 14.53$ раз относительно самой первой версии!
...
Наибольшее ускорение относительно базовой версии - $\frac{6142775058}{422734737} \approx 14.53$. Всего была написана 31 строчка на ассемблере/с использованием интринсиков. Также был подсчитан так называемый **коэффициент оптимизации**, он составил:

$\alpha = \frac{общее \text{ } ускорене}{количество \text{ } ассемблерных \text{ } строк} \cdot 100 = \frac{14.53}{31} \cdot 100 \approx 46.87$
